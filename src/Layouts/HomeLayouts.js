    ...
    <Box border={0}>
      ...
      >
        <Flex flexDirection="column" alignItems="flex-start" gap={3}>
          ...
          <Text color="whiteAlpha.700" maxW="30ch">
            Jl Alamat Kantor atau Rumah Anda No Sekian Kecamatan Anda Kota Anda
            Provinsi Anda. Kode Pos Anda Berapa
          </Text>

          <Flex flexDirection="row" gap={3} alignItems="center">
            {socialMediaLinks.map((link, index) => (
              <SocialMediaIcon key={index} icon={link.icon} href={link.href} />
            ))}
          </Flex>
        </Flex>
      </Box>
              ...
              >
                ...
                >
                  ...
                  {router.asPath === navItem.href && (
                    <Box background="green.700" h={0.5} w="24px" rounded="lg" />
                  )}
                </Flex>
              </Box>
            </PopoverTrigger>
